!function(a) {
    ...
    function c() {
        if (b.XMLHttpRequest) return new b.XMLHttpRequest();
        try {
            return new b.ActiveXObject("MSXML2.XMLHTTP.3.0");
        } catch (a) {}
    ...
    b.nanoajax = a, a.ajax = function(a, b) {
        "string" == typeof a && (a = {
            url: a
        });
        var e = a.headers || {}, f = a.body, g = a.method || (f ? "POST" : "GET"), h = a.withCredentials || !1, i = c();
        i.withCredentials = h, i.onreadystatechange = function() {
            4 == i.readyState && b(i.status, i.responseText, i);
        }, f && (d(e, "X-Requested-With", "XMLHttpRequest"), d(e, "Content-Type", "application/x-www-form-urlencoded")), 
        i.open(g, a.url, !0);
        for (var j in e) i.setRequestHeader(j, e[j]);
        i.send(f);
    };
}({}, function() {
    return this;
            ...
            var b = {
                ...
                return a.options = {}, a.performAction = function(a, b, c) {
                    ...
                    switch (c) {
                      ...
                      case 29:
                        return b.yytext = d(1, 2).replace(/\\"/g, '"'), 74;
    ...
    function a(a) {
        if (!document.querySelectorAll) {
            ...
            document.querySelectorAll = function(a, b, c, e, f) {
                for (f = document.all, b = [], a = a.replace(/\[for\b/gi, "[htmlFor").split(","), 
                c = a.length; c--; ) {
        ...
        s = !0, p = [], o = {}, n = a || {}, n.error = n.error || !1, n.offset = n.offset || 100, 
        n.success = n.success || !1, n.selector = n.selector || ".b-lazy", n.separator = n.separator || "|", 
        n.container = n.container ? document.querySelectorAll(n.container) : !1, n.errorClass = n.errorClass || "b-error", 
        n.breakpoints = n.breakpoints || !1, n.successClass = n.successClass || "b-loaded", 
        n.src = m = n.src || "data-src", r = window.devicePixelRatio > 1, o.top = 0 - n.offset, 
        o.left = 0 - n.offset, t = l(c, 25), u = l(h, 50), h(), k(n.breakpoints, function(a) {
            return a.width >= window.screen.width ? (m = a.src, !1) : void 0;
        }), b();
    }
    function b() {
        g(n.selector), s && (s = !1, n.container && k(n.container, function(a) {
            i(a, "scroll", t);
        }), i(window, "resize", u), i(window, "resize", t), i(window, "scroll", t)), c();
    }
    function c() {
        for (var b = 0; q > b; b++) {
            var c = p[b];
            (e(c) || f(c)) && (a.prototype.load(c), p.splice(b, 1), q--, b--);
        }
        0 === q && a.prototype.destroy();
    }
    function d(a, b) {
        if (b || a.offsetWidth > 0 && a.offsetHeight > 0) {
            var c = a.getAttribute(m) || a.getAttribute(n.src);
            if (c) {
                var d = c.split(n.separator), e = d[r && d.length > 1 ? 1 : 0], f = new Image();
                k(n.breakpoints, function(b) {
                    a.removeAttribute(b.src);
                }), a.removeAttribute(n.src), f.onerror = function() {
                    n.error && n.error(a, "invalid"), a.className = a.className + " " + n.errorClass;
                }, f.onload = function() {
                    "img" === a.nodeName.toLowerCase() ? a.src = e : a.style.backgroundImage = 'url("' + e + '")', 
                    a.className = a.className + " " + n.successClass, n.success && n.success(a);
                }, f.src = e;
            } else n.error && n.error(a, "missing"), a.className = a.className + " " + n.errorClass;
        }
    }
    function e(a) {
    ...
    function f(a) {
        return -1 !== (" " + a.className + " ").indexOf(" " + n.successClass + " ");
    }
    function g(a) {
        var b = document.querySelectorAll(a);
        q = b.length;
        for (var c = q; c--; p.unshift(b[c])) ;
    }
    function h() {
        o.bottom = (window.innerHeight || document.documentElement.clientHeight) + n.offset, 
        o.right = (window.innerWidth || document.documentElement.clientWidth) + n.offset;
    }
    function i(a, b, c) {
    ...
    function k(a, b) {
        if (a && b) for (var c = a.length, d = 0; c > d && b(a[d], d) !== !1; d++) ;
    }
    function l(a, b) {
        var c = 0;
        return function() {
            var d = +new Date();
            b > d - c || (c = d, a.apply(p, arguments));
        };
    }
    ...
    return a.prototype.revalidate = function() {
        ...
        n.container && k(n.container, function(a) {
            j(a, "scroll", t);
        }), j(window, "scroll", t), j(window, "resize", t), j(window, "resize", u), q = 0, 
        p.length = 0, s = !0;
    }, a;
}), Handlebars.registerHelper("truncateWords", function(a, b) {
    if (b = b || 12, "string" == typeof a) {
        var c = a, d = c.split(" ");
        if (d.length > b) {
            var e = d.splice(0, b), f = e.join(" ");
            c = f += "...";
        }
        return c;
    }
    ...
    {
        var c = qwery(".container-blocks")[0];
        qwery("body")[0];
    }
    if ("undefined" != typeof Packery) var d = new Packery(c, {
        ...
        var c = function(c) {
            function d(b) {
                a.setTimeout(function() {
                    var a = b.parentNode.getBoundingClientRect(), c = a.bottom - a.top, d = b.offsetHeight, e = (c - d) / 2;
                    b.style.marginTop = e + "px";
                }, 30);
            }
            function e(a, b) {
                var c;
                b = b || {}, nanoajax.ajax("/assets/html/lightbox.html", function(d, e) {
                    c = e, console.log(c);
                    var f = Handlebars.compile(c), g = f(b);
                    console.log(g), a.innerHTML = g;
                });
            }
            function f(b) {
                classie.remove(b, "open"), a.setTimeout(function() {
                    h.removeChild(b);
                }, 1e3);
            }
            function g() {
                var a = b.createElement("div");
                h.appendChild(a), a.className = "layer-lightbox", e(a, c);
                var g = qwery(".close-lightbox", a)[0], i = qwery(".dim-lightbox", a)[0], j = qwery("img", a)[0];
                d(j), bean.on(g, "click", function() {
                    f(a);
                }), bean.clone(i, g), classie.add(a, "open");
            }
            var h = b.getElementsByTagName("body")[0];
            return {
                init: g()
            };
        };
    ...
    new Blazy({
        ...
        success: function(b) {
            a.setTimeout(function() {
                b.className = b.className.replace(/\blazy\b/, "");
            }, 200), d && d.layout();
        }
    });
}(window, document);